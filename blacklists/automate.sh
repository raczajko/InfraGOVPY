...
wget https://github.com/borestad/blocklist-abuseipdb/raw/refs/heads/main/abuseipdb-s100-7d.ipv4 -O sources/abuseipdb-s100-7d.ipv4
...
wget https://iplists.firehol.org/files/firehol_abusers_1d.netset -O sources/firehol_abusers_1d.netset
...
tail -n +32 sources/firehol_abusers_1d.netset >> todos.txt
...
/usr/bin/iprange --print-ranges todos.txt > listado_full.txt

#listado_fail2ban
tail -n +14 sources/abuseipdb-s100-7d.ipv4 | cut -d '#' -f 1 > todosf2b.txt
...
/usr/bin/iprange --print-single-ips todosf2b.txt > listado_fail2ban.txt
